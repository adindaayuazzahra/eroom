                ...
                @foreach ($acaras as $acara)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('user.acara.edit', ['id' => $acara->id]) }}"
                                class="btn btn-warning btn-sm {{ $acara['tanggal'] <=Carbon::now()->addDays(2)->toDateString() || $acara['status'] == 1? 'disabled': '' }}"><i
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('acara.delete.do', ['id' => $acara->id]) }}" class="btn btn-danger">Hapus</a>
                        {{-- <form action="{{ route('acara.delete.do', ['id'=> $acara->id]) }}" method="POST">
                            {{ csrf_field()}}
